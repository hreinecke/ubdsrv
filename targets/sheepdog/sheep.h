...
int sd_read_inode(struct sd_queue_ctx *ctx, struct sheepdog_vdi *vdi);
int sd_update_inode(struct sd_queue_ctx *ctx, struct sheepdog_vdi *sd_vdi,
		    uint64_t req_oid);
int sd_resolve_vid(struct sd_queue_ctx *ctx, struct sheepdog_vdi *sd_vdi,
		   uint32_t idx);
int sd_update_vid(struct sd_queue_ctx *ctx, struct sheepdog_vdi *sd_vdi,
		  uint32_t idx);
int sd_exec_read(struct sd_queue_ctx *ctx, struct sheepdog_vdi *sd_vdi,
